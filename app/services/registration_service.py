...
class RegistrationService:
    ...
    async def register(self, data: UserCreate) -> User:
        ...
        user = await self.repo.create(
            ...
            voice_opt_in=data.voice_opt_in,
            ...
            currently_menstruating=data.currently_menstruating,
            ...
            trying_to_conceive=data.trying_to_conceive,
            menopause_status=data.menopause_status,
            pregnancy_history_count=data.pregnancy_history_count,
            miscarriage_history_count=data.miscarriage_history_count,
            c_section_history_count=data.c_section_history_count,
            age_at_first_period=data.age_at_first_period,
            symptom_patterns=data.symptom_patterns,
            ...
            symptom_preferences=data.symptom_preferences,
            hot_flashes=data.hot_flashes,
            sleep_changes=data.sleep_changes,
            mood_changes=data.mood_changes,
            bone_health=data.bone_health,
